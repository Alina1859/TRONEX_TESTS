...
export const PROVIDER_PRIORITY_WITH_ORDER_COMBINATIONS: ProviderPriorityWithOrderCombination[] = [
  ...
  {
    priorityDescription:
      "Разные приоритеты: TronLocal-2 (100), TronLocal-3 (60), TronLocal (40), TronLocal-1 (20)",
  ...
  {
    priorityDescription:
      "Постепенное увеличение приоритетов: TronLocal-1 (10), TronLocal-2 (30), TronLocal-3 (60), TronLocal (100)",
  ...
  {
    priorityDescription:
      "Постепенное уменьшение приоритетов: TronLocal-1 (100), TronLocal-2 (60), TronLocal-3 (30), TronLocal (10)",
  ...
  {
    priorityDescription:
      "Граничные значения: TronLocal-1 (0), TronLocal-2 (1), TronLocal-3 (50), TronLocal (100)",
  ...
  {
    priorityDescription:
      "Обратный порядок: TronLocal (100), TronLocal-3 (75), TronLocal-2 (50), TronLocal-1 (25)",
  ...
  {
    priorityDescription:
      "Тройка: TronLocal-2, TronLocal-3, TronLocal высокие (100, 90, 80), TronLocal-1 низкий",
  ...
  {
    priorityDescription:
      "Разные уровни: TronLocal-1 (5), TronLocal-2 (15), TronLocal-3 (35), TronLocal (55)",
  ...
  {
    priorityDescription:
      "Разные уровни: TronLocal-1 (80), TronLocal-2 (85), TronLocal-3 (90), TronLocal (95)",
